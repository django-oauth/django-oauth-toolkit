...
_LAZY = {
    ...
    # Concrete protected-resource views.
    "ProtectedResourceView": "oauth2_provider.resource_server.views.generic",
    "ScopedProtectedResourceView": "oauth2_provider.resource_server.views.generic",
    "ReadWriteScopedResourceView": "oauth2_provider.resource_server.views.generic",
    "ClientProtectedResourceView": "oauth2_provider.resource_server.views.generic",
    "ClientProtectedScopedResourceView": "oauth2_provider.resource_server.views.generic",
    "ProtectedResourceMetadataView": "oauth2_provider.resource_server.views.generic",
    "ScopedProtectedResourceMetadataView": "oauth2_provider.resource_server.views.generic",
    "ReadWriteScopedProtectedResourceMetadataView": "oauth2_provider.resource_server.views.generic",
    "ClientProtectedResourceMetadataView": "oauth2_provider.resource_server.views.generic",
