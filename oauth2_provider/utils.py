...
``oauth2_provider.utils`` has moved to
``oauth2_provider.core.utils``.
...
from oauth2_provider.core import utils as _moved


warnings.warn(
    "oauth2_provider.utils has moved to oauth2_provider.core.utils. "
