...
``oauth2_provider.bcp`` has moved to
``oauth2_provider.core.bcp``.
...
from oauth2_provider.core import bcp as _moved


warnings.warn(
    "oauth2_provider.bcp has moved to oauth2_provider.core.bcp. "
