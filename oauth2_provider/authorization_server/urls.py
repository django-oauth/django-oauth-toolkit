...
from oauth2_provider.authorization_server.views.par import PushedAuthorizationRequestView
...
base_urlpatterns = [
    ...
    path("par/", PushedAuthorizationRequestView.as_view(), name="pushed-authorization-request"),
