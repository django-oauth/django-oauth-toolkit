...
``oauth2_provider.http`` has moved to
``oauth2_provider.core.http``.
...
from oauth2_provider.core import http as _moved


warnings.warn(
    "oauth2_provider.http has moved to oauth2_provider.core.http. "
